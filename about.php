                    ...
                    <div class="row">
                        ...
                        <div class="col-6 gallery-right">
                            <div class="single-img wow fadeInRight" data-wow-delay="0.5s">
                                <img class="animate-float-bob-y" src="assets/img/circle-image-gallery/03.jpg"
                                    alt="">
                            </div>
            ...
            <div class="col-lg-6 col-md-9 col-sm-11">
                <div class="faq-content pl-xl-5">
                    ...
                    <p>
                        ...
                        totam rem aperieaqueys epsa quae abillo inventore veritatis et quase
                    </p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="collapse" id="itemOne" data-parent="#accordionFaq">
                                <div class="accordion-content">
                                    <p>
                                        Orem psum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor
                                        incididunt ut labore ets dolore magna aliqua uispsum suspendisse
                                    </p>
                                </div>
                            </div>
                        </div>
